package com.example.edy.penampilwebpage;
...
/**
 * Created by edy on 19/10/17.
 */

public class KonekInternetTask extends AsyncTask<String,Void,String> {
    Context ctx;

    public KonekInternetTask(Context ct){
        ctx = ct;
    }
